...
#### groupManage.asyncGetGroupInfo(group\_id, froce) ⇒ [`Promise.<GroupInfoAndSettings>`](broken-reference)
...
#### groupManage.getGroupMembers(group\_id) ⇒ [`Array.<GroupMember>`](broken-reference)
...
#### groupManage.getGruopMessage(gid) ⇒ [`Array.<Meta>`](broken-reference)
...
#### groupManage.asyncGetInfo(params) ⇒ [`Promise.<GroupInfoAndSettings>`](broken-reference)
...
#### groupManage.asyncGetAnouncementById(params) ⇒ [`Promise.<GroupAnnouncement>`](broken-reference)
...
#### groupManage.asyncAnnouncementEdit(params) ⇒ [`Promise.<GroupAnnouncement>`](broken-reference)
...
#### groupManage.asyncCreate(params) ⇒ [`Promise.<GroupInfoAndSettings>`](broken-reference)
...
#### groupManage.asyncGetSettings(group\_id) ⇒ [`Promise.<GroupInfoAndSettings>`](broken-reference)
...
#### groupManage.asyncBanAll(params) ⇒ [`Promise.<GroupBanAllResponse>`](broken-reference)
...
#### groupManage.asyncOwnerTransfer(params) ⇒ [`Promise.<GroupUserRelationResponse>`](broken-reference)
...
#### groupManage.asyncApply(params) ⇒ [`Promise.<GroupUserRelationResponse>`](broken-reference)
...
#### groupManage.asyncApplyHandle(params) ⇒ [`Promise.<GroupUserRelationResponse>`](broken-reference)
...
#### rosterManage.asyncGetRosterInfo(roster\_id, force) ⇒ [`Promise.<RosterItem>`](broken-reference)
...
#### rosterManage.asyncRegester(opt) ⇒ [`Promise.<UserSettings>`](broken-reference)
...
#### rosterManage.getAllRosterDetail() ⇒ [`Array.<RosterItem>`](broken-reference)
...
#### rosterManage.asyncGetUserProfile(force) ⇒ [`Promise.<UserProfile>`](broken-reference)
...
#### rosterManage.getRosterMessageByRid(uid) ⇒ [`Array.<Meta>`](broken-reference)
...
#### rosterManage.getRosterInfo(rid) ⇒ [`RosterItem`](broken-reference)
...
#### rosterManage.asyncSearchRosterByName(params) ⇒ [`Promise.<RosterItem>`](broken-reference)
...
#### rosterManage.asyncSearchRosterById(params) ⇒ [`Promise.<RosterItem>`](broken-reference)
...
#### sysManage.asyncFileUpload(param) ⇒ [`Promise.<FileUploadResult>`](broken-reference)
...
#### sysManage.asyncGetGroupAvatarUploadUrl(params) ⇒ [`Promise.<FileUpload>`](broken-reference)
...
#### sysManage.asyncGetFileUploadChatFileUrl(params) ⇒ [`Promise.<FileUpload>`](broken-reference)
...
#### userManage.getConversationList() ⇒ [`Array.<ConversationItem>`](broken-reference)
...
#### userManage.asyncGetProfile() ⇒ [`Promise.<UserProfile>`](broken-reference)
...
#### userManage.asyncGetSettings() ⇒ [`Promise.<UserSettings>`](broken-reference)
